...
A weekend vibecode project. Not a product. Not advice on how to build software.

## Why this exists

I'm a DJ. There's no one-size-fits-all setup for DJing — the field has strong players, and each one wants your library locked to their ecosystem. Moving between them is painful.
...
Validated against a golden reference exported by MIXO for two playlists. Python stdlib only — no extra dependencies for the converter itself.
...
- Replicates MIXO's conversion behavior for a specific fixture — not a general-purpose Engine → Rekordbox tool.
